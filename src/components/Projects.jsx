...
const Projects = ({ darkMode }) => {
  ...
  const projectsList = [
    {
      id: 1,
      title: 'EduSphere AI — Adaptive Learning Platform',
      github: 'https://github.com/EduSphere-AI/edusphere-ai-ui',
      description:
        'Led product for an AI-powered learning platform with personalized learning paths, built on React and TypeScript. Drove 40% improvement in user engagement metrics.',
      image: edusphere_image,
      tags: ['Product Strategy', 'React', 'TypeScript']
    },
    {
      id: 2,
      ...
      description:
        'Enterprise-grade logging infrastructure for BL602 microcontrollers with centralized MQTT brokers and a RESTful API. Reduced incident response time by 60%.',
      image: log_collector_image,
      tags: ['Embedded Systems', 'Python', 'API Design']
    },
  ];
